...
public class SignUpController {
	...
	@PostMapping("/signUp")
	public String signUpSubmit(@ModelAttribute("signUp") Member member, Model model, HttpSession session) {
		...
		if (file != null && !file.isEmpty()) {
			try {
				...
				System.out.println("📷 파일명: "
						+ (member.getProfileImageFile() != null ? member.getProfileImageFile().getOriginalFilename()
								: "null"));
	...
	public String expertSubmit(@RequestParam("memberId") String memberId, @RequestParam("career") String career,
			@RequestParam("university") String university, @RequestParam("certification") String certification,
			@RequestParam("introduction") String introduction, @RequestParam("expertFiles") List<MultipartFile> files) {
		...
		// ✅ DTO 생성 후 저장
		ExpertProfileDTO dto = new ExpertProfileDTO(memberId, career, university, certification, introduction,
				savedFileNames);
