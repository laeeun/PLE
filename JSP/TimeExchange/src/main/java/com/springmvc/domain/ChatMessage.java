...
public class ChatMessage {
    ...
    private String receiverProfileImage;   // 받는 사람 프로필 이미지
	...
	public String toString() {
		return "ChatMessage [messageId=" + messageId + ", roomId=" + roomId + ", senderId=" + senderId + ", receiverId="
				...
				+ ", receiverName=" + receiverName + ", receiverProfileImage=" + receiverProfileImage + ", content="
				+ content + ", fileUrl=" + fileUrl + ", type=" + type + ", createdAt=" + createdAt + ", isMine="
				+ isMine + ", read=" + read + "]";
	}
